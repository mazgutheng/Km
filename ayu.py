...
wait = {
    ...
    "sticker":True,
    "selfbot":True,
    "mention":"Ngintip mele -_-",
    "Respontag":"Tag mele ntar jatuh cinta gak da yang tanggung jawab ya..!!! -_-",
    "welcome":"Selamat datang & semoga betah n bahagia",
    "comment":"Like by Dd_AyuVO1S",
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           rnd = ["Ngetag mele ntar beper gk da yang tanggung jawab.. jangan sampek puskun ya beb"]
                           p = random.choice(rnd)
                           lang = 'id'
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "Siap Dd kuh ...Kami datang\n\nhttp://line.me/ti/p/afr1z4l\nhttp://line.me/ti/p/afr1z4l")
...
#===========BOT UPDATE============#
                        elif cmd == "tagall" or text.lower() == 'asslamualaikum':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup ã"+str(ginfo.name)+"ã pasukan sdah di luar Bosq")
                                except:
                                    pass
